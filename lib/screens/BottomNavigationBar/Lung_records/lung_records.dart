...
import 'package:intune/screens/BottomNavigationBar/Lung_records/lung_record_report.dart';
...
class LungRecord extends StatelessWidget {
  const LungRecord({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () => navigateTo(context, LungReport()),
              child: Container(
                width: 350,
                height: 75,
