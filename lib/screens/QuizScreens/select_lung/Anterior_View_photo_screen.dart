...
import 'package:intune/screens/QuizScreens/select_lung/Anterior_view_screen.dart';
...
class AnteriorPhotoScreen extends StatefulWidget {
  const AnteriorPhotoScreen({Key? key}) : super(key: key);

  @override
  State<AnteriorPhotoScreen> createState() => _AnteriorPhotoScreen();
}

class _AnteriorPhotoScreen extends State<AnteriorPhotoScreen> {
  int _groupValue = -1;
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          ElevatedButton(
            onPressed: () {
              navigateTo(context, AnteriorViewScreen());
            },
            style: ButtonStyle(
