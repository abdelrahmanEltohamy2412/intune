...
import 'package:intune/screens/QuizScreens/select_lung/Posterior_View_position_screen.dart';
...
import 'lung_view_screen.dart';

class posteriorPhotoScreen extends StatefulWidget {
  const posteriorPhotoScreen({Key? key}) : super(key: key);

  @override
  State<posteriorPhotoScreen> createState() => _posteriorPhotoScreen();
}

class _posteriorPhotoScreen extends State<posteriorPhotoScreen> {
  int _groupValue = -1;
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          ElevatedButton(
            onPressed: () {
              navigateTo(context, PosteriorViewScreen());
            },
            style: ButtonStyle(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            navigateTo(context, LungViewScreen());
          },
        ),
